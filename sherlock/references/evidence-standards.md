# Sherlock Kanıt Standartları (Evidence Standards 5.0)

> v5.0: `scripts/literature_guard.py` icra motorudur. Format + tarih kapısı offline çalışır; canlı doğrulama deep modda. Arama-kayıt tam logu `.sherlock/literature/<tarih>-search-log.md`'de tutulur, R&V raporuna özet tablo konur (600 kelime tavanı korunur).

Öncelikli uygulayıcı `sherlock-research-verify`. Diğer tüm ajanlar da dış kaynak gösterirken bu kurallara uyar.
...
Tam log: `.sherlock/literature/<tarih>-search-log.md` (`literature_guard.py --init-log` iskeleti). Research & Verify raporuna özet tablo konur:
