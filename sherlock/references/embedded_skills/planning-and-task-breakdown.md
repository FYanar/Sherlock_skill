...
Acceptance criteria are per-task and answer "did we build the right thing?". They sit on top of the project-wide Definition of Done, the standing bar every task clears before it counts as done. (Sherlock v5.0 notu: Done barı olarak Sherlock `40-verdict.md` §8 + `evidence-standards.md` CONFIRMED kapısı geçerlidir.)
