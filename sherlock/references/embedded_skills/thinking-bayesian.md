...
> **Not (Sherlock v5.0 paketi):** Bu paketde `thinking-probabilistic` ayrı dosya olarak bulunmaz; aralık/tahmin/kalibrasyon işleri bu dosyanın Trigger Card + kalibrasyon bölümüyle yapılır. Açık prior + likelihood varsa aşağıdaki Bayes kuralını, yoksa base-rate × likelihood-ratio kestirimini kullan.
