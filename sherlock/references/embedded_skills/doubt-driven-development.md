...
- **Do NOT add this skill to a persona's `skills:` frontmatter.** A persona that follows Step 3 would spawn another persona — the orchestration anti-pattern (Sherlock v5.0 notu: harici orchestration dosyası bu pakette yoktur; kural: personalar başka persona çağırmaz).
...
- **Repo orchestration rules** (Sherlock v5.0 notu: harici orchestration dosyası bu pakette yoktur; ana oturumdan orkestrasyon kuralı geçerlidir): this skill orchestrates from the main session. A persona calling another persona is anti-pattern B — see Loading Constraints above.
