"""
Agent Pre-Flight Context Generator for OneClickDock Knowledge Base.
Gathers high-density context (AST contracts, past bug findings, config constraints,
and benchmark rules) for AI agents before they write or refactor code.
"""
...
class AgentContextGenerator:
    ...
    def generate_preflight_context(self, target: str, project_scope: str = "OneClickDock") -> str:
        ...
        lines = [
            ...
            "This context was automatically retrieved from OneClickDock Knowledge Base to guide code edits.",
            "---",
        ...
        lines.append("## 3. Configuration & Benchmark Run Metrics")
        if run_winners:
        ...
        lines.append("---")
        lines.append("⚠️ **Mandatory Protocol for AI Agent**: Ensure that any code edits comply with the contracts and analysis rules above. Do not break existing metal coordination or score separation gates.")
